# **[0x14. JavaScript - Web scraping](https://intranet.alxswe.com/projects/333)**
...
Write a script that prints the title of a [Star Wars](https://swapi-api.alx-tools.com/) movie where the episode number matches a given integer.
